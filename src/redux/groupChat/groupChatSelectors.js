...
export const getAttachedFiles = (state) =>
  state.groupChat.attachedFilesToMessage.filesData;
export const getAttachFileLoading = (state) =>
  state.groupChat.attachedFilesToMessage.isLoading;
...
export const getGroupChatData = (state) => state.groupChat;
