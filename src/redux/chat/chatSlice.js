  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(attachFileToMessageThunk.fulfilled, (state, {payload}) => {
        ...
        state.attachedFilesToMessage.filesURL = [...state.attachedFilesToMessage.filesURL, payload]
      })
...
export const { setMessages, setUsers, setActiveData, addMessage, clearAttachedFiles } = chatSlice.actions;
