  ...
  return (
    ...
    >
      <div>
        ...
        <Slider onChange={(value)=>setSingleValue(value)} defaultValue={100} min={0} max={200}/>
      ...
      <div>
        ...
        <Slider range onChange={(value=>setRangeValue(value))} defaultValue={[100, 120]} min={0} max={200}/>
